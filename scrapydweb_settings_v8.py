...
MAIN_SCRAPYD_HOST = os.getenv("MAIN_SCRAPYD_HOST", "127.0.0.1")
MAIN_SCRAPYD_PORT = os.getenv('MAIN_SCRAPYD_PORT', 6800)

SALVE_SCRAPYD_HOST = os.getenv('SALVE_SCRAPYD_HOST', '127.0.0.1')
SALVE_SCRAPYD_PORT = os.getenv('SALVE_SCRAPYD_PORT', 6800)
...
#   - e.g. ('', '', '127.0.0.1', '6800', '') or ('username', 'password', 'localhost', '6801', 'group')
SCRAPYD_SERVERS = [
    f'{MAIN_SCRAPYD_HOST}:{MAIN_SCRAPYD_PORT}',
    f'{SALVE_SCRAPYD_HOST}:{SALVE_SCRAPYD_PORT}',
...
LOCAL_SCRAPYD_SERVER = f'{MAIN_SCRAPYD_HOST}:{MAIN_SCRAPYD_PORT}'
...
SCRAPYD_LOGS_DIR = '/app/enthost_spider/logs/'
